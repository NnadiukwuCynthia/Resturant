...
const FaqContent = () => {
  return (
    <div className="faqContent">
      <p className="faqContent__Question">What is your address?</p>
      <p className="faqContent__Answer">Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br /> Our main entrance is through the Bresca front door.</p>
      <p className="faqContent__Question">What are the hours of your operation?</p>
      <p className="faqContent__Answer">cuisine is open for dinner service only, Wednesday to Sunday. <br />
          <span className="faqContent__Answer__span">Seating Times</span> <br />
      ...
      <p className="faqContent__Answer">Corkage is $100 per 750ml.</p>
    </div>
  )
}
